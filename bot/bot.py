...
def _import_modules():
    ...
    global setup_guild_config

    try:
        from bot.guild_config import setup_guild_config  # type: ignore
        print("✅ Import: bot.guild_config")
    except ModuleNotFoundError:
        try:
            from guild_config import setup_guild_config  # type: ignore
            print("✅ Import: guild_config (root)")
        except Exception as e:
            setup_guild_config = None
